...
const string BLUE = "B";
const string MAGENTA = "M";
const string CYAN = "C";
const string WHITE = "W";

const string B_BLACK = "B";
const string B_RED = "R";
const string B_GREEN = "G";
const string B_YELLOW = "Y";
const string B_BLUE = "B";
const string B_MAGENTA = "M";
const string B_CYAN = "C";
const string B_WHITE = "W";
#endif
